...
const ItemsBanner = () => {
  return (
    <div className="bg-muted rounded-t-xl">
      <Container>
        <div className="flex w-full flex-col gap-6 pb-10 pt-10 lg:grid lg:grid-cols-2">
          <Card className="border-primary border-t-[12px]">
            ...
            <CardContent className="text-muted-foreground flex flex-col gap-6">
              <h2>
                Vind uw ideale oplaadoplossing, van residentiële installaties
                tot grote bedrijven.
              </h2>
              <a
                href="/offerte"
