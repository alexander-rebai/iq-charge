...
const navigation = {
  main: [
    { name: "Thuis", href: "/thuis" },
    { name: "Zakelijk", href: "/bedrijf" },
  ...
  social: [
    {
      name: "Facebook",
      href: "https://www.facebook.com/share/1ANNb3NGoc/?mibextid=wwXIfr",
    ...
    {
      name: "LinkedIn",
      href: "https://www.linkedin.com/company/laadexpert-be/",
      icon: (props: IconProps) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
    ...
    <footer className="relative bg-[#1C3C36]">
      ...
      <div className="relative mx-auto max-w-7xl overflow-hidden px-6 py-12 lg:px-8">
        ...
        {!hideLinks && (
          <nav
            aria-label="Footer"
            className="mt-8 flex flex-wrap justify-center gap-x-12 gap-y-3 text-sm/6"
          >
